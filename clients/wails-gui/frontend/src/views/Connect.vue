  ...
  <div class="connect-overlay">
    <div class="connect-box">
      <div class="connect-brand">
        <img :src="logoSrc" alt="Ghost" class="brand-gif" />
        <div class="mark">Ghost</div>
      ...
      <div v-else class="local-section">
        <p class="local-desc">
          Connect to the local Ghost server running on this machine.
        </p>
...
const logoSrc = computed(() => {
  ...
  return asset(theme === 'light' ? '/ico/ghost-icon-light.png' : '/ico/ghost-icon-dark.png')
})
